...
// }
function Mapa(_a) {
    var config = _a.config, onConfigChange = _a.onConfigChange;
    ...
    var handleBoundsChange = function (_a) {
        var center = _a.center, zoom = _a.zoom;
        console.log('Bounds changed - center:', center);
        console.log('Bounds changed - zoom:', zoom);
        setCenter(center);
        setZoom(zoom);
        onConfigChange(__assign(__assign({}, config), { zoom: zoom })); // Atualiza o estado no componente pai
    };
    return ((0, jsx_runtime_1.jsxs)(pigeon_maps_1.Map, { provider: function () { return wmsUrl; }, dprs: [1, 2], height: height, width: width, center: currentCenter, defaultCenter: defaultCenter, zoom: currentZoom, onBoundsChanged: handleBoundsChange, children: [(0, jsx_runtime_1.jsx)(pigeon_maps_1.ZoomControl, {}), (0, jsx_runtime_1.jsx)(pigeon_maps_1.Draggable, { offset: [60, 87], anchor: currentCenter, onDragEnd: setCenter, children: (0, jsx_runtime_1.jsx)(PersonPinCircle_1.default, {}) })] }));
}
